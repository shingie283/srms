...
$level=$_POST['level'];
$sql="INSERT INTO  tblclasses(ClassName,ClassYear,Level) VALUES(:classname,:classyear,:level)";
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="number" name="classyear" required="required" class="form-control" id="success">
                                                            <span class="help-block">Eg- Year etc</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- NC,ND, etc</span>
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
