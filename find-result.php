                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="Candidate No">Enter your Candidate No</label>
                                        <input type="varchar" class="form-control" id="rollid" placeholder="Enter Your Candidate No" autocomplete="off" name="Candidate No">
                                	</div>
                               <div class="form-group">
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassName); ?>&nbsp;<?php echo htmlentities($result->Level); ?></option>
<?php }} ?>
 </select>
</div>
