...
$classid=$_POST['class'];
$_SESSION['candidateno']=$candidateno;
$_SESSION['classid']=$classid;
$qery = "SELECT   tblstudents.StudentName,tblstudents.candidateno,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.CandidateNo=:candidateno and tblstudents.ClassId=:classid ";
$stmt = $dbh->prepare($qery);
$stmt->bindParam(':candidateno',$candidateno,PDO::PARAM_STR);
...
<p><b>Student Caandidate No :</b> <?php echo htmlentities($row->CandidateNo);?>
...
// Code for result
 ...
 $query ="select t.StudentName,t.CandidateNo,t.ClassId,t.marks,SubjectId,tblsubjects.SubjectName from (select sts.StudentName,sts.CandidateNo,sts.ClassId,tr.marks,SubjectId from tblstudents as sts join  tblresult as tr on tr.StudentId=sts.StudentId) as t join tblsubjects on tblsubjects.id=t.SubjectId where (t.CandidateNo=:CandidateNo and t.ClassId=:classid)";
$query= $dbh -> prepare($query);
$query->bindParam(':candidateno',$candidateno,PDO::PARAM_STR);
...
<?php
echo htmlentities("Invalid Candidate No");
 }
?>
                                        </div>
